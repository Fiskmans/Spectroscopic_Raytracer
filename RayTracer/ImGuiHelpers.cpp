...
namespace Tools
{
	...
	FullscreenTexture GetNextTexture()
	{
		...
		{
			ImguiHelperGlobals::globalTextureStack.push_back(ImguiHelperGlobals::globalTextureFactory->CreateTexture(CommonUtilities::Vector2<unsigned int>(1600,1200),DXGI_FORMAT_R8G8B8A8_UNORM,"Imgui debug texture"));
		}
